...
import { FaFileAlt, FaComments, FaChartLine, FaMapMarkedAlt } from "react-icons/fa";
...
const Home = ({ setUser }) => {
    ...
    <div className="bg-white text-[#0a0a0a] font-sans min-h-screen overflow-x-hidden">
      ...
      >
        <div className="flex items-center gap-2">
          <div className="w-7 h-7 rounded-lg bg-[#0a0a0a] flex items-center justify-center shadow-[0_4px_14px_rgba(o,0,0,0.18)]">
      ...
      <section className="relative pt-20 pb-14 overflow-hidden bg-[#f8f9fa]">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          className="text-3xl md:text-5xl font-extrabold leading-[1.1] tracking-tight mb-4 text-[#0a0a0a] [text-shadow:0_4px_24px_rgba(0,0,0,0.12)]">
            Job Interview <br />
            <span className="text-black/70">Don't Have to Stuck</span><br />
            <span className="text-black/50">Anymore !</span>
          </motion.h1>
          <motion.p
               initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.55, delay: 0.2}}
          className="text-black/50 font-semibold text-sm leading-relaxed max-w-md mx-auto mb-6 [text-shadow:0_2px_10px_rgba(0,0,0,0.06)]">
          ...
          className="relative gap-2  overflow-hidden bg-[#0a0a0a]/80 backdrop-blur-2xl text-white font-bold px-5 py-2.5 rounded-lg text-xs cursor-pointer border border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.3)] transition-all hover:border-white/20"
            >
             <span className="flex items-center gap-2 justify-center"> Get Started For Free <FaArrowRight/></span> 
              <span className="absolute inset-0 bg-linear-to-br from-white/[0.1] via-transparent to-transparent pointer-events-none rounded-lg"/>
            </motion.button>
          </motion.div>
        </div>
      ...
      <section className="py-16 bg-[#f8f9fa]">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mt-10">
            <div className="inline-flex items-center px-3 py-1.5 rounded-full border border-black/15 bg-black/15 text-black/70 text-xs font-medium mb-4">
            AI Powered Agents
            </div>
            ...
            <p className="text-black/50 text-sm max-w-2xl mx-auto mt-4 font-semibold leading-relaxed">
              <p>Fresher.AI is an AI-powered interview preparation platform designed to help job seekers ace their interviews with confidence. It brings together multiple specialized AI agents — including a Resume Builder, Roadmap Builder, and Resume Scorer — to guide you through every stage of your career journey. Practice realistic technical and HR interviews, get instant feedback on correctness, clarity, problem-solving, and communication, and track your progress over time with detailed performance analytics.</p>
            </p>
          </div>
             ...
             [
  {
    icon: FaFileAlt,
    title: "Resume Agent",
    desc: "Build and optimize your resume with AI-powered suggestions tailored to your target role.",
  },
  {
    icon: FaComments,
    title: "Interview Agent",
    desc: "Practice realistic technical and HR interviews with an AI that adapts questions to your responses.",
  },
  {
    icon: FaChartLine,
    title: "Feedback Agent",
    desc: "Get instant, detailed feedback on correctness, clarity, communication, and problem-solving skills.",
  },
  {
    icon: FaMapMarkedAlt,
    title: "Roadmap Agent",
    desc: "Receive a personalized learning roadmap to bridge skill gaps and land your dream job.",
  },
].map((agent,i)=>(
  <motion.div
