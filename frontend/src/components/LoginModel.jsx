        ...
        <div className="relative p-7">
          ...
          <div className="mt-7">
            <motion.button
              ...
              className="flex w-full items-center justify-center gap-3 py-3 rounded-xl border border-white/15 bg-white/10 backdrop-blur-md hover:border-white/25 hover:bg-white/[0.14] shadow-inner transition-all"
